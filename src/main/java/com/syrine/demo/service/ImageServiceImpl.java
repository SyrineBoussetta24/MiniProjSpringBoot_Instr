...
public class ImageServiceImpl implements ImageService {
	...
	@Override
	public Image uplaodImageInstr(MultipartFile file,Long idInstr)
	throws IOException {
	Instrument i = new Instrument();
	i.setIdInstrument(idInstr);
	...
	@Override
	public List<Image> getImagesParInstr(Long instrId) {
		Instrument i = instrumentRepository.findById(instrId).get();
	return i.getImages();
	}
}